...
hist = model.fit (x_train, y_train, epochs =10000000, batch_size = 10, validation_split = 0.3, callbacks=[es])
...
# print (submission)
# print (submission.shape) #(715, 1)
submission.to_csv(path + 'submit/' + "ES_visualize_val_submit_0907_1618.csv")
