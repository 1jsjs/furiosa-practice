...
dense3 = Dense(150,activation='relu')(dropout2)
dropout4 = Dropout(0.2)(dense3)
dense5 = Dense(150,activation='relu')(dropout4)
dropout6 = Dropout(0.2)(dense5)
dense7 = Dense(150,activation='relu')(dropout6)
dropout8 = Dropout(0.2)(dense7)
dense9 = Dense(150,activation='relu')(dropout8)
dropout10 = Dropout(0.2)(dense9)
dense11 = Dense(100,activation='relu')(dropout10)
dropout12 = Dropout(0.2)(dense11)
dense13 = Dense(50,activation='relu')(dropout12)
dropout14 = Dropout(0.2)(dense13)
output1 = Dense(3,activation='softmax')(dropout14)
...
# filepath = "".join([path, "k43_", date, filename])
# # 파일명 예
...
dropout
loss : 0.12090805917978287
acc : 0.97
[1 0 1 0 1 1 1 0 0 1 1 1 2 0 2 1 2 1 1 0 1 2 0 0 0 0 0 2 2 1 1 2 2 0 2 1]
[1 0 1 0 1 1 1 0 0 1 1 1 2 0 2 1 2 1 1 0 1 2 0 0 0 0 0 2 2 2 1 2 2 0 2 1]
acc_score :  0.9722222222222222
걸린 시간 :  13.57 s
"""