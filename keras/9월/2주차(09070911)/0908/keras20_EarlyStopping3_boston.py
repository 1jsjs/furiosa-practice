...
epochs = 1000000
batch 50 validation_split 0.6

r2 : 0.4921009944728181
loss(mse) :  42.27946472167969
mse :  <function mean_squared_error at 0x000001EECC498180>
RMSE :  6.502266364850169
"""
...
hist = model.fit (x_train, y_train, epochs = 1000000, batch_size =50, validation_split = 0.6, callbacks=[es])
