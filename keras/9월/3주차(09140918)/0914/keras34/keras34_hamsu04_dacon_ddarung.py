...
dense3 = Dense(64)(dropout2)
dropout4 = Dropout(0.2)(dense3)
dense5 = Dense(64)(dropout4)
dropout6 = Dropout(0.2)(dense5)
dense7 = Dense(32)(dropout6)
dropout8 = Dropout(0.2)(dense7)
dense9 = Dense(8)(dropout8)
dropout10 = Dropout(0.2)(dense9)
output1 = Dense(1)(dropout10)
...
9.14
dropout
r2 :  0.5663816906173911
MSE:  2865.638409688915
RMSE:  53.53165801363633
"""