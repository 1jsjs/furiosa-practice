...
dense9 = Dense(8, activation='relu')(dropout8)
dropout10 = Dropout(0.2)(dense9)
output1 = Dense(1, activation='relu')(dropout10)
...
hist = model.fit (x_train, y_train, epochs = 100, batch_size = 50, validation_split = 0.3, callbacks=[es])
...
9.14
dropout
r2 :  0.3142277002334595
MSE:  22698.71875
RMSE:  150.6609396957287
"""