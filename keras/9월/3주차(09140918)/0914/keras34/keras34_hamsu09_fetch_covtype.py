...
dense3 = Dense(800,activation='relu')(dropout2)
dropout4 = Dropout(0.2)(dense3)
dense5 = Dense(600,activation='relu')(dropout4)
dense6 = Dense(100,activation='relu')(dense5)
dropout7 = Dropout(0.2)(dense6)
dense8 = Dense(500,activation='relu')(dropout7)
dropout9 = Dropout(0.2)(dense8)
output1 = Dense(7,activation='softmax')(dropout9)
