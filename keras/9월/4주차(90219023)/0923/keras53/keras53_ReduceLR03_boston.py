...
path = "./_save/keras53_ReduceLR03_boston/"
filename = '{epoch:04d}-{val_loss:4f}.keras' #history에서 때오는 것임
filepath = "".join([path, "k53_", date, filename])
mcp = ModelCheckpoint ( 
    monitor='val_loss',
    mode='auto',
    save_best_only = True,
...
loss(mse) :  17.032711029052734
r2 : 0.795387744115358
mse :  <function mean_squared_error at 0x0000015B191DA9E0>
RMSE :  4.127070587493715
걸린 시간: 10.32


*ReduceLR
learning_rate = 0.003
loss(mse) :  17.55656623840332
r2 : 0.7890947330470977
mse :  <function mean_squared_error at 0x0000027E24DE6D40>
RMSE :  4.190055619470391
걸린 시간: 8.94
"""