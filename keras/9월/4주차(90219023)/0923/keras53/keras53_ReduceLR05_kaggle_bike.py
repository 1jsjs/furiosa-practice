...
path_save= "./_save/keras53_ReduceLR05_kaggle_bike/"
...
hist = model.fit (x_train, y_train, epochs = 1000, batch_size = 50, validation_split = 0.3, callbacks=[es,mcp, rlr])
...
# ReduceLR
learning_rate = 0.001
r2 :  0.34320372343063354
MSE:  21739.626953125
RMSE:  147.44363992090334
