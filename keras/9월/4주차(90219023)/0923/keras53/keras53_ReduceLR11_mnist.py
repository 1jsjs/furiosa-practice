...
path_save= "./_save/keras53_ReduceLR11_mnist/"
...
model.fit (x_train, y_train, epochs=100, batch_size=128, verbose=1, validation_split=0.1, callbacks=[es,mcp,rlr])
end_time = time.time()
...
0923 optimizer - learning_rate = 0.0001
loss : 0.027662789449095726
acc : 0.9904999732971191
accuracy score : 0.9905
걸린 시간 : 213.8 s


# ReduceLR - learning_rate = 0.00001
loss : 0.030072864145040512
